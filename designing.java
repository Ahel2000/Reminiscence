...
public class designing extends Activity {
...
//        });
    ...
    private void makethecall(){
        ...
        if(i==0){
            intent.setData(Uri.parse("tel:8789936929"));
        }
        else if(1==1){
            intent.setData(Uri.parse("tel:9163409146"));
        }
        else if(i==2){
            intent.setData(Uri.parse("tel:8336830221"));
        }
        else if(i==3){
            intent.setData(Uri.parse("tel:8240259127"));
        }
        else if(i==4){
            intent.setData(Uri.parse("tel:7031882709"));
        }
        else if(i==5){
            intent.setData(Uri.parse("tel:9359746978"));
        }
        else if(i==6){
            intent.setData(Uri.parse("tel:9330317608"));
        }

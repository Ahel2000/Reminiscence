...
public class sponsorship extends Activity {
...
//        });
    ...
    private void makethecall(){
        ...
        if(i==0){
            intent.setData(Uri.parse("tel:9665577169"));
        }
        else if(1==1){
            intent.setData(Uri.parse("tel:9434192101"));
        }
        else if(i==2){
            intent.setData(Uri.parse("tel:9001339300"));
        }
        else if(i==3){
            intent.setData(Uri.parse("tel:9398942959"));
        }
        else if(i==4){
            intent.setData(Uri.parse("tel:7980971985"));
        }
        else if(i==5){
            intent.setData(Uri.parse("tel:9359746978"));
        }
        else if(i==6){
            intent.setData(Uri.parse("tel:6296452972"));
        }
        else if(i==7){
            intent.setData(Uri.parse("tel:8306603912"));
        }
        else if(i==8){
            intent.setData(Uri.parse("tel:6291275090"));
        }
